...
const SETUP: Section[] = [
  ...
  },
  {
    emoji: '②',
    title: 'お直し項目・業者を登録する',
    lead: 'お直しの種類・料金と、外注先の業者を先に登録しておくと、受付がスムーズになります。',
    feature: 'repairs_master',
    steps: [
      { title: 'お直し項目・料金', body: '「設定」→「お直し項目・料金」から、裾上げ・刺繍などの加工内容と料金を登録します。写真で撮影するだけの自動取込（OCR）にも対応しています。' },
      { title: 'お直し加工業者', body: '「設定」→「お直し加工業者」から、外注先の業者名・連絡先を登録します（自社のみで対応する場合は登録不要です）。' },
    ],
  },
  {
    emoji: '③',
    title: '学校・商品マスターを登録する（いちばん大事）',
    lead: '学校ごとの指定品目・締切と、扱う商品（制服・体操着など）をまとめて登録できます。最初に済ませておくと、あとの作業がぐっと楽になります。',
    feature: 'products',
    steps: [
      { title: '登録場所', body: '「設定」→「学校・商品マスタ」から、学校名・読み仮名・指定品目・採寸受付期間・発注締切日と、商品名・サイズ・価格をまとめて登録します。' },
      { title: '写真から自動登録（OCR）', body: '学校からもらった案内文やチラシ、価格表をスマホで撮影すると、学校情報と品目リストをまとめて自動で読み取って登録できます。毎年の更新もこれでOK。' },
    ],
  },
  {
    emoji: '④',
    title: 'スタッフのLINEを登録する（かんたんLINEモード）',
    lead: 'この機能を使うと、スタッフは管理画面を開かなくても、LINEの返信だけで「今日のお直し・お渡し」タスクを確認・完了できます。',
    feature: 'kantan_line',
    steps: [
      { title: 'QRコードで登録', body: '「設定」→「かんたんLINEモード」でスタッフ登録コードを発行し、スタッフのスマホのLINEで「スタッフ登録 コード」と送信してもらいます。1回だけで大丈夫です。' },
    ],
  },
  {
    emoji: '⑤',
