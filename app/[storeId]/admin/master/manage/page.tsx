    ...
    return (
      <div className="min-h-screen bg-gray-50 pb-24">
        ...
        <header className="bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-4 py-4 flex items-center gap-2 sticky top-0 z-20">
          <button onClick={() => { if (typeof window !== 'undefined' && window.history.length > 1) router.back(); else router.push(`/${storeId}/admin/settings/staff`) }} className="p-1"><ChevronLeft size={24} /></button>
