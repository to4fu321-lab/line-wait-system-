                  ...
                  {!showReg ? (
                    ...
                    <div className="rounded-2xl border-2 border-indigo-200 bg-indigo-50/50 p-4 space-y-3">
                      ...
                      <div className="border-t border-indigo-200 pt-3 text-center space-y-2">
                        ...
                        <img
                          src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&margin=10&data=${encodeURIComponent(`https://liff.line.me/${process.env.NEXT_PUBLIC_LIFF_ID_UNIFORM || process.env.NEXT_PUBLIC_LIFF_ID || ''}/${storeId}`)}`}
